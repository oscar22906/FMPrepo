...
namespace Polyart
{
    public class FirstPersonController : MonoBehaviour
    {
        ...
        [Header("Interaction")]
        [SerializeField] private bool InteractionLine;
        ...
        void Update()
        {
            ...
            if (Inventory.active && !Cursor.visible || Inventory.active && firstPerson)
            {
            ...
            if (Input.GetKeyDown(KeyCode.I))
            {
                ...
                Inventory.SetActive(Inventory.active ? false : true);
        ...
        {
            if (Input.GetKeyDown(attackKey)) // check conditions; equip system
            {
        ...
        private void HandleInteractionCheck()
        {
            ...
            {
                if (InteractionLine)
                    Debug.DrawLine(playerCamera.transform.position, hit.point, Color.red, 2.5f);
